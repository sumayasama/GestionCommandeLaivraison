...
public class AdminController implements Serializable {
    ...
    @EJB
    private control.AdminFacade ejbFacade;
...
public String connexion(){
 Admin a= ejbFacade.find(current.getLogin());
          if (a==null ||!a.getPwd().equals(current.getPwd())){
              FacesContext.getCurrentInstance().addMessage(null,
                            new FacesMessage(FacesMessage.SEVERITY_ERROR, "Identifiant ou mot de passe erroné",
                                    "Erreur"));
    ...
    public Admin getAdmin(java.lang.String id) {
